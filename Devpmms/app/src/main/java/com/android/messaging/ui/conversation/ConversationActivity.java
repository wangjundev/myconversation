...
public class ConversationActivity extends BugleActionBarActivity
    ...
    static void handleShowFileChooser(ValueCallback<Uri[]> filePathCallback, boolean isTakePicture){
    ...
    static void handleOpenFileChooser(ValueCallback<Uri> uploadMsg, boolean isTakePicture){
        if(null != mFileChooserHandler) {
